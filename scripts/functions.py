...
def plot_roc(name, labels, predictions, **kwargs):
    ...
    fp, tp, _ = sklearn.metrics.roc_curve(labels.argmax(axis=1), predictions.argmax(axis=1))
...
def plot_prc(name, labels, predictions, **kwargs):
    ...
    precision, recall, _ = sklearn.metrics.precision_recall_curve(labels.argmax(axis=1),
